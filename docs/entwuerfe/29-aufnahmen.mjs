/*
 * Aufnahmen des Entwurfs 29 — beide Themes, jeder Abschnitt einzeln.
 *
 *   node docs/entwuerfe/29-aufnahmen.mjs          → /tmp/srvpanel-entwurf
 *   ZIEL=/pfad node docs/entwuerfe/29-aufnahmen.mjs
 *
...
const entwurf = join(hier, '29-optik-rework.html')
const ziel = process.env.ZIEL ?? '/tmp/srvpanel-entwurf'
...
const abschnitte = ['befunde', 'massstab', 'uebersicht', 'abonnement', 'formular', 'schmal']
