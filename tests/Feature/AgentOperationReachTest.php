...
final class AgentOperationReachTest extends TestCase
{
    ...
    private const WITHOUT_LIFECYCLE = [
        ...
        'backup.list' => 'Listet auf, was unter /var/lib/srvpanel/backups wirklich liegt — `docs/117 §9` Punkt 7. Kein Lebenslauf und kein Vorgang: Sie ändert nichts, läuft am selben Zeitgeber wie backup.verify, und ihr Ergebnis ist ein Befund im Bestand des Panels. Es braucht sie, weil der Ablageort `0710 root:srvpanel` ist — durchsuchbar für die Gruppe, nicht auflistbar, also kommt das Panel mit `glob()` nicht heran. Der Aufruf steht in App\\Support\\Diagnose\\Checks\\Backups::orphans().',
        ...
        'pg.remote.access' => 'Schreibt den verwalteten Block in pg_hba.conf und die Horchadresse; beides ist eine Eigenschaft des Servers — der Bestand des Panels steht in db_user_networks und ist die Quelle, nicht die Folge (docs/38 §14).',
        ...
        'db.console.indexes' => 'Siehe db.console.tables.',
        ...
        'pg.console.indexes' => 'Siehe pg.console.tables.',
