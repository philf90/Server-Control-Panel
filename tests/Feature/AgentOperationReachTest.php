...
final class AgentOperationReachTest extends TestCase
{
    ...
    private const WITHOUT_LIFECYCLE = [
        ...
        'pg.server.info' => 'Liest, ob ein PostgreSQL läuft, welche Fassung, ob die Rolle root '
            .'angelegt ist und was von abgebrochenen Vorgängen übrig blieb. Sie ändert nichts, und '
            .'sie ist die einzige pg.*-Operation, die auch dann eine Antwort hat, wenn noch gar '
            .'nichts eingerichtet ist (docs/38 §6.1) — das Panel entscheidet daraus, ob es '
            .'PostgreSQL anbietet.',
