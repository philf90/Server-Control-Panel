...
# unter ihm weggehen.
for timer in srvpanel-usage srvpanel-packages srvpanel-tls srvpanel-cron srvpanel-dns srvpanel-diagnose srvpanel-backup-verify srvpanel-backups srvpanel-traffic; do
