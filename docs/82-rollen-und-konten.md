...
- **Das Löschen von Adminkonten** (§1.1) — solange das Protokoll den Handelnden
  ...
  **Die Frage ist am 2. September 2026 beantwortet, und der Plan steht als
  `docs/901`** (am 9. September gegen `main @ 08a0b55` neu gemessen): eine
  Abschrift des Namens auf der Protokollzeile selbst, wie `subscription_name`
  seit `docs/35`. Diese Zeile hier gilt, bis Schritt 5 jenes Plans gebaut ist —
  **gebaut ist nichts**.
