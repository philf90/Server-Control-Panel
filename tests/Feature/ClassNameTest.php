...
final class ClassNameTest extends TestCase
{
    ...
    private const VOCABULARY = [
        ...
        'back', 'blank',
        'block', 'brand', 'branch', 'breadcrumb', 'button', 'cell', 'check', 'choice', 'choices', 'codes',
        ...
        'skeleton', 'small',
        'source', 'spaced', 'split', 'sr', 'stack', 'stacks', 'state', 'strength', 'string', 'sub', 'subline',
