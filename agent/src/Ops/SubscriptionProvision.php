...
final class SubscriptionProvision implements Op
{
    ...
    /**
     * Die Willkommensseite für das erste DocumentRoot.
     *
     * Sie steht seit P4 in {@see WelcomePage} — jede weitere Domain bekommt
     * dieselbe Seite über `web.site.apply`, und zwei Fassungen davon wären
