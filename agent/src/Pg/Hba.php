...
final class Hba
{
    ...
    {
        /*
         * **Die Rechnung steht in {@see Cidr}, die Politik hier.**
         *
         * Sie stand bis zum 25. August 2026 vollständig an dieser Stelle — und
         * war schon damals die geteilte: Vier Klassen nennen sie im Kommentar
         * als *die* Schreibweise, und das Panel ruft sie über die
         * Namensraumgrenze hinweg direkt auf. A9 Schritt 7 braucht dieselbe
         * Rechnung für die Netze einer Panel-Anmeldung, und die hat mit
         * PostgreSQL nichts zu tun.
         *
         * **Was hier bleibt, ist die Ablehnung von `/0`** — und die ist Politik
         * und keine Rechnung: Für einen Datenbankzugang ist „das ganze
         * Internet" ein Fehler, für eine Anmeldebeschränkung wäre es bloss die
         * Voreinstellung mit mehr Zeichen.
         *
         * > **Zwei Systeme mit derselben Rechnung und verschiedenen Regeln
         * > teilen die Rechnung und nicht die Regeln.**
         */
        $normalized = Cidr::normalize($value, $field);
        ...
        if (str_ends_with($normalized, '/0')) {
            throw AgentException::denied(sprintf(
                ...
                .'kommt.', trim(Guard::string($value, $field)),
            ));
        }
